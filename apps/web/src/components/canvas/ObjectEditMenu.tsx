...
export const ObjectEditMenu: React.FC<ObjectEditMenuProps> = ({
  x,
  y,
  objectType,
    ...
    <>
      ...
      >
        ...
        <div style={{ position: 'relative' }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <BackgroundColorIcon size={16} color={currentBackgroundColor} />
        ...
        <div style={{ position: 'relative' }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <TextColorIcon size={16} color={currentTextColor} />
